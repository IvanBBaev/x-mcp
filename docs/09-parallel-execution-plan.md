...
| T-315 ⚡ | 3.10 | S | `SECURITY.md`, `.github/ISSUE_TEMPLATE/` | Disclosure policy + issue templates. **Done 2026-07-31** (advisory-only reporting, in/out-of-scope keyed to T1–T17, three issue forms with a secrets warning; both remaining items are unblocked as of 2026-08-25, the repo live and released: enable private vulnerability reporting in Settings → Security, and confirm GitHub resolves the relative advisory URL in `config.yml`). | T-001 |
