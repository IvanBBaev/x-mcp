...
// none: **the surface is full**. `x_thread_create` landed at its terse-wording floor (see its
// description/schema) to fit inside the ~1,555 B that remained at the 41-tool baseline. The
